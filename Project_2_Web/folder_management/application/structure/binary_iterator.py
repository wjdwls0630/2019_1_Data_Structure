...
class BinaryIterator(object):
    ...
    def cast_list_recur(self, node: BNodeType):
        ...
        if node.is_leaf():
            ...
            self.m_List[self.m_length] = node
            self.m_length += 1
            return
        else:
            #  if node has child
    ...
    def is_tail(self) -> bool:
        return self.m_cur_idx is self.m_length
    ...
    def next_is_tail(self) -> bool:
        return self.m_cur_idx is self.m_length-1
