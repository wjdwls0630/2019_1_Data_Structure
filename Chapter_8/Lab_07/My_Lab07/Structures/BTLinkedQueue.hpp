...
#ifndef _BTLINKEDQUEUE_HPP
#define _BTLINKEDQUEUE_HPP
...
/**
*	@brief	BTLinkedQueue class.
*	@details	This class
*/
template <typename T>
class LinkedQueue{
protected:
    DNodeType<T> lq_Head_Node;	/// Head node for programming list more easy. It has not data, only has real head pointer
    DNodeType<T> lq_Tail_Node;	/// Head node for programming list more easy. It has not data, only has real head pointer
    DNodeType<T>* lq_Front;	//index of one infront of the first element.
    DNodeType<T>* lq_Rear;	//index of the last element.
